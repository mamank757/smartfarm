 ...
 *  Versi: 1.1 (Modal dikunci — hanya tombol TUTUP yg menutup)
 * ------------------------------------------------------------
 *  Cara kerja:
...
(function () {
    ...
    function buatModalPeta() {
        ...
        //  Pengguna hanya bisa menutup via tombol "✕ TUTUP".
        // ─────────────────────────────────────────────────────────────────────
        // (listener klik overlay dihapus — tidak ada event handler di sini)
    ...
    // =========================================================================
    //  TUTUP MODAL PETA
    //  Satu-satunya cara menutup modal adalah via tombol "✕ TUTUP"
    // =========================================================================
    ...
    // =========================================================================
    //  TOMBOL BACK ANDROID — MODAL DIKUNCI
    //  Back button tidak menutup peta; pengguna harus tekan tombol TUTUP.
    // =========================================================================

    window.addEventListener('popstate', function() {
        // Modal dikunci — back button tidak menutup peta
        // (pengguna harus menekan tombol TUTUP)
    });

    // =========================================================================
    //  SWIPE KE BAWAH — MODAL DIKUNCI
    //  Swipe tidak menutup modal; cukup deteksi touchstart untuk Leaflet.
    // =========================================================================
    ...
    console.log(
        '%c📍 patch_peta_koordinat.js v1.1 aktif — Modal Dikunci (hanya tombol TUTUP)',
