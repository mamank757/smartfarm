...
(function () {
    ...
    var databasePestisida = [
        { id: 1,  bahanAktif: "Metomil",               merekPopuler: "Lannate 25 WP",      merekLain: [], grupIrac: "1A", grupFrac: null, formulasi: "WP", phStabil: [5, 7],   basaKuat: false, targetHama: ["Ulat Grayak", "Kutu Daun", "Thrips", "Penggerek Polong"], targetPenyakit: [], catatan: CATATAN_PADI },
        ...
        { id: 3,  bahanAktif: "BPMC (Fenobukarb)",      merekPopuler: "Bassa 50 EC",        merekLain: [], grupIrac: "1A", grupFrac: null, formulasi: "EC", phStabil: [5, 7],   basaKuat: false, targetHama: ["Wereng Coklat", "Walang Sangit", "Kepik Hijau"], targetPenyakit: [], catatan: null },
        { id: 4,  bahanAktif: "Klorpirifos",            merekPopuler: "Dursban 200 EC",     merekLain: ["Lentrek 400 EC"], grupIrac: "1B", grupFrac: null, formulasi: "EC", phStabil: [4, 7],   basaKuat: false, targetHama: ["Kutu Putih", "Ulat Grayak", "Wereng Coklat", "Semut"], targetPenyakit: [], catatan: CATATAN_PADI },
        { id: 5,  bahanAktif: "Profenofos",             merekPopuler: "Curacron 500 EC",    merekLain: [], grupIrac: "1B", grupFrac: null, formulasi: "EC", phStabil: [4, 7],   basaKuat: false, targetHama: ["Ulat Grayak", "Kutu Daun", "Thrips", "Kutu Kebul"], targetPenyakit: [], catatan: CATATAN_PADI },
        { id: 6,  bahanAktif: "Dimetoat",               merekPopuler: "Perfekthion 400 EC", merekLain: [], grupIrac: "1B", grupFrac: null, formulasi: "EC", phStabil: [5, 7],   basaKuat: false, targetHama: ["Kutu Daun", "Thrips", "Lalat Buah"], targetPenyakit: [], catatan: null },
        { id: 7,  bahanAktif: "Fipronil",               merekPopuler: "Regent 50 SC",       merekLain: [], grupIrac: "2B", grupFrac: null, formulasi: "SC", phStabil: [5, 9],   basaKuat: false, targetHama: ["Wereng Coklat", "Penggerek Batang Padi", "Orong-orong", "Rayap", "Walang Sangit"], targetPenyakit: [], catatan: null },
        { id: 8,  bahanAktif: "Sipermetrin",            merekPopuler: "Ripcord 50 EC",      merekLain: [], grupIrac: "3A", grupFrac: null, formulasi: "EC", phStabil: [4, 6.5], basaKuat: false, targetHama: ["Ulat Grayak", "Wereng Coklat", "Walang Sangit"], targetPenyakit: [], catatan: CATATAN_PADI },
        { id: 9,  bahanAktif: "Deltametrin",            merekPopuler: "Decis 25 EC",        merekLain: [], grupIrac: "3A", grupFrac: null, formulasi: "EC", phStabil: [4, 6.5], basaKuat: false, targetHama: ["Ulat Grayak", "Walang Sangit", "Kutu Daun", "Kepik"], targetPenyakit: [], catatan: CATATAN_PADI },
        { id: 10, bahanAktif: "Lamda-Sihalotrin",       merekPopuler: "Matador 25 EC",      merekLain: [], grupIrac: "3A", grupFrac: null, formulasi: "EC", phStabil: [4, 6.5], basaKuat: false, targetHama: ["Ulat Grayak", "Kutu Daun", "Lalat Buah", "Kutu Kebul"], targetPenyakit: [], catatan: CATATAN_PADI },
        { id: 11, bahanAktif: "Alfametrin",             merekPopuler: "Fastac 15 EC",       merekLain: [], grupIrac: "3A", grupFrac: null, formulasi: "EC", phStabil: [4, 6.5], basaKuat: false, targetHama: ["Ulat Grayak", "Kutu Daun", "Penghisap Buah"], targetPenyakit: [], catatan: null },
        ...
        { id: 13, bahanAktif: "Tiametoksam",            merekPopuler: "Actara 25 WG",       merekLain: [], grupIrac: "4A", grupFrac: null, formulasi: "SG", phStabil: [5, 9],   basaKuat: false, targetHama: ["Wereng Coklat", "Kutu Kebul", "Thrips"], targetPenyakit: [], catatan: null },
        { id: 14, bahanAktif: "Dinotefuran",            merekPopuler: "Oshin 20 WP",        merekLain: [], grupIrac: "4A", grupFrac: null, formulasi: "WP", phStabil: [5, 9],   basaKuat: false, targetHama: ["Wereng Coklat", "Kutu Kebul", "Kepik Hijau"], targetPenyakit: [], catatan: null },
        { id: 15, bahanAktif: "Nitenpiram",             merekPopuler: "Tenchu 20 SG",       merekLain: [], grupIrac: "4A", grupFrac: null, formulasi: "SG", phStabil: [5, 9],   basaKuat: false, targetHama: ["Wereng Coklat", "Wereng Punggung Putih"], targetPenyakit: [], catatan: null },
        { id: 16, bahanAktif: "Spinosad",               merekPopuler: "Tracer 120 SC",      merekLain: [], grupIrac: "5",  grupFrac: null, formulasi: "SC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Penggorok Daun", "Thrips"], targetPenyakit: [], catatan: null },
        { id: 17, bahanAktif: "Spinetoram",             merekPopuler: "Endure 120 SC",      merekLain: [], grupIrac: "5",  grupFrac: null, formulasi: "SC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Penggorok Daun", "Thrips", "Ulat Kubis"], targetPenyakit: [], catatan: null },
        ...
        { id: 19, bahanAktif: "Emamektin Benzoat",      merekPopuler: "Proclaim 5 SG",      merekLain: [], grupIrac: "6",  grupFrac: null, formulasi: "SG", phStabil: [5, 7],   basaKuat: false, targetHama: ["Ulat Grayak", "Penggorok Daun", "Ulat Pelipat Daun"], targetPenyakit: [], catatan: null },
        { id: 20, bahanAktif: "Pimetrozin",             merekPopuler: "Chess 50 WG",        merekLain: [], grupIrac: "9B", grupFrac: null, formulasi: "SG", phStabil: [5, 9],   basaKuat: false, targetHama: ["Wereng Coklat", "Kutu Kebul", "Kutu Daun"], targetPenyakit: [], catatan: null },
        { id: 21, bahanAktif: "Heksitiazoks",           merekPopuler: "Nissorun 50 EC",     merekLain: [], grupIrac: "10A",grupFrac: null, formulasi: "EC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Tungau Merah", "Tungau Kuning"], targetPenyakit: [], catatan: null },
        { id: 22, bahanAktif: "Bacillus thuringiensis", merekPopuler: "Turex 50 WP",        merekLain: [], grupIrac: "11A",grupFrac: null, formulasi: "WP", phStabil: [6, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Ulat Kubis", "Ulat Penggerek Buah"], targetPenyakit: [], catatan: null },
        { id: 23, bahanAktif: "Diafentiuron",           merekPopuler: "Pegasus 500 SC",     merekLain: [], grupIrac: "12A",grupFrac: null, formulasi: "SC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Kutu Kebul", "Thrips", "Tungau", "Kutu Daun"], targetPenyakit: [], catatan: null },
        { id: 24, bahanAktif: "Klorfenapir",            merekPopuler: "Arjuna 200 EC",      merekLain: [], grupIrac: "13", grupFrac: null, formulasi: "EC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Thrips", "Kutu Daun", "Tungau"], targetPenyakit: [], catatan: null },
        { id: 25, bahanAktif: "Dimehipo",               merekPopuler: "Spontan 400 SL",     merekLain: [], grupIrac: "14", grupFrac: null, formulasi: "SL", phStabil: [5, 8],   basaKuat: false, targetHama: ["Penggerek Batang Padi", "Wereng Coklat", "Ulat Pelipat Daun", "Lalat Bibit"], targetPenyakit: [], catatan: null },
        { id: 26, bahanAktif: "Kartap Hidroklorida",    merekPopuler: "Padan 50 SP",        merekLain: [], grupIrac: "14", grupFrac: null, formulasi: "SP", phStabil: [5, 7],   basaKuat: false, targetHama: ["Penggerek Batang Padi", "Ulat Pelipat Daun", "Wereng Coklat"], targetPenyakit: [], catatan: CATATAN_PADI },
        { id: 27, bahanAktif: "Lufenuron",              merekPopuler: "Match 50 EC",        merekLain: [], grupIrac: "15", grupFrac: null, formulasi: "EC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Penggerek Batang Padi", "Ulat Kubis"], targetPenyakit: [], catatan: null },
        { id: 28, bahanAktif: "Klorfluazuron",          merekPopuler: "Atabron 50 EC",      merekLain: [], grupIrac: "15", grupFrac: null, formulasi: "EC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Ulat Krop", "Ulat Penggerek Polong"], targetPenyakit: [], catatan: null },
        { id: 29, bahanAktif: "Novaluron",              merekPopuler: "Rimon 100 EC",       merekLain: [], grupIrac: "15", grupFrac: null, formulasi: "EC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Ulat Pelipat Daun", "Penggorok Daun"], targetPenyakit: [], catatan: null },
        { id: 30, bahanAktif: "Buprofezin",             merekPopuler: "Applaud 10 WP",      merekLain: [], grupIrac: "16", grupFrac: null, formulasi: "WP", phStabil: [5, 8],   basaKuat: false, targetHama: ["Wereng Coklat (Nimfa)", "Kutu Kebul", "Kutu Putih"], targetPenyakit: [], catatan: null },
        { id: 31, bahanAktif: "Metoksifenozida",        merekPopuler: "Intrepid 250 SC",    merekLain: [], grupIrac: "18", grupFrac: null, formulasi: "SC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Ulat Krop", "Ulat Penggerek Buah"], targetPenyakit: [], catatan: null },
        { id: 32, bahanAktif: "Tebufenozida",           merekPopuler: "Mimic 20 F",         merekLain: [], grupIrac: "18", grupFrac: null, formulasi: "SC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Ulat Penggerek Buah"], targetPenyakit: [], catatan: null },
        { id: 33, bahanAktif: "Piridaben",              merekPopuler: "Samite 135 EC",      merekLain: [], grupIrac: "21A",grupFrac: null, formulasi: "EC", phStabil: [5, 7],   basaKuat: false, targetHama: ["Tungau", "Kutu Kebul", "Thrips"], targetPenyakit: [], catatan: null },
        { id: 34, bahanAktif: "Indoksakarb",            merekPopuler: "Ammate 150 EC",      merekLain: [], grupIrac: "22A",grupFrac: null, formulasi: "EC", phStabil: [5, 7],   basaKuat: false, targetHama: ["Ulat Grayak", "Ulat Krop", "Ulat Buah"], targetPenyakit: [], catatan: null },
        ...
        { id: 36, bahanAktif: "Klorantraniliprol",      merekPopuler: "Prevathon 50 SC",    merekLain: [], grupIrac: "28", grupFrac: null, formulasi: "SC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Penggerek Batang Padi", "Ulat Grayak", "Ulat Pelipat Daun"], targetPenyakit: [], catatan: null },
        { id: 37, bahanAktif: "Flubendiamida",          merekPopuler: "Belt 480 SC",        merekLain: [], grupIrac: "28", grupFrac: null, formulasi: "SC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Ulat Grayak", "Penggerek Batang Padi", "Ulat Penggerek Polong"], targetPenyakit: [], catatan: null },
        { id: 38, bahanAktif: "Sianantraniliprol",      merekPopuler: "Exirel 100 SE",      merekLain: [], grupIrac: "28", grupFrac: null, formulasi: "EC", phStabil: [5, 8],   basaKuat: false, targetHama: ["Kutu Kebul", "Penggorok Daun", "Ulat Grayak", "Thrips"], targetPenyakit: [], catatan: null },
        { id: 39, bahanAktif: "Flonikamid",             merekPopuler: "Ulala 50 WG",        merekLain: [], grupIrac: "29", grupFrac: null, formulasi: "SG", phStabil: [5, 9],   basaKuat: false, targetHama: ["Wereng Coklat", "Kutu Daun", "Thrips", "Kutu Kebul"], targetPenyakit: [], catatan: null },
        ...
        { id: 41, bahanAktif: "Tembaga Hidroksida",     merekPopuler: "Kocide 77 WP",       merekLain: [], grupIrac: null, grupFrac: "M1", formulasi: "WP", phStabil: [6, 8],   basaKuat: true,  targetHama: [], targetPenyakit: ["Antraknosa", "Busuk Buah", "Kanker Bakteri", "Busuk Daun"], catatan: null },
        { id: 42, bahanAktif: "Mankozeb",               merekPopuler: "Dithane M-45 WP",    merekLain: [], grupIrac: null, grupFrac: "M3", formulasi: "WP", phStabil: [5, 7],   basaKuat: false, targetHama: [], targetPenyakit: ["Antraknosa", "Bercak Daun", "Busuk Daun", "Karat Daun"], catatan: null },
        { id: 43, bahanAktif: "Pupuk Daun NPK + Mikro", merekPopuler: "Gandasil/Growmore",  merekLain: [], grupIrac: null, grupFrac: null, formulasi: "SL", phStabil: [4, 6.5], basaKuat: false, targetHama: [], targetPenyakit: [], catatan: null },
        ...
        { id: 45, bahanAktif: "Difenokonazol",          merekPopuler: "Score 250 EC",       merekLain: [], grupIrac: null, grupFrac: "3",  formulasi: "EC", phStabil: [5, 7], basaKuat: false, targetHama: [], targetPenyakit: ["Bercak Daun", "Antraknosa", "Embun Tepung", "Karat Daun"], catatan: null },
